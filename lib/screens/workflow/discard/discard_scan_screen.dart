...
class DiscardScanScreen extends StatefulWidget {
  DiscardScanScreen({Key? key}) : super(key: key);

  @override
  _DiscardScanScreenState createState() => _DiscardScanScreenState();
}

class _DiscardScanScreenState extends State<DiscardScanScreen> {
  Barcode? result;
