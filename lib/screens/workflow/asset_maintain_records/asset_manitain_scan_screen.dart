...
class AssetMaintainScanScreen extends StatefulWidget {
  AssetMaintainScanScreen({Key? key}) : super(key: key);

  @override
  _AssetMaintainScanScreenState createState() =>
      _AssetMaintainScanScreenState();
}

class _AssetMaintainScanScreenState extends State<AssetMaintainScanScreen> {
  Barcode? result;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Asset Maintainance Record"),
        ),
